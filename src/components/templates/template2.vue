<template>
    <div class="m-lg-5">
        ...
        <TextViewer2 :dataPassed="dataValue" v-if="dataValue.type=='header'"  :class="dataValue.type" />
        ...
        <div v-for="(dataValue, index3) in data.articles[current]" :key="index3">
            ...
            <ImageViewer2 :dataPassed="dataValue.image" :class="dataValue.type" v-if="dataValue.type=='image'"/>
...
import ImageViewer2 from '../../components/image_component/image_viewer2.vue';
import TextViewer from '../../components/text_component/text_viewer1.vue';
import TextViewer2 from '../../components/text_component/text_viewer2.vue';
import VideoViewer from '../../components/video_component/video_viewer2.vue';
  ...
  data() {
    return {
        ...
        },
        {
            ...
            image:{
                url:"https://img.zeit.de/politik/ausland/2020-07/libyen-konflikt-aegypten-militaereinsatz-chalifa-haftar-foto/wide__820x461__desktop",
