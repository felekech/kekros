<template>
  <div>
  {{id}}
    <FeatureTemplate :storyData="storyData" />
  </div>
</template>
<script>
      ...
      storyData: {
        ...
        headers: [
          [
            ...
            {
              text:
                'Ein Gastbeitrag von <a href="" style="color:black;"><b>Anders Ravik Jupskås</b></a> and <a href="" style="color:black;"><b>Daniel Köhler</b></a>',
              type: "contributors",
            },
            {
...

            {
              ...
              image: {
                url:
                  "https://img.zeit.de/gesellschaft/zeitgeschehen/2020-07/rechtsterrorismus-deutschland-hoechste-anzahl-studie-rtv-universitaet-oslo-bild-2/wide__950x422__mobile",
                caption:
                  "The brother of one of those killed in Hanau laid flowers to commemorate. © Thomas Lohnes / Getty Images",
              },
            },
          ],
          [
          ...
          articles: [
            [
              ...
              },
              {
                ...
                image_and_text: {
                  url:
                    "https://img.zeit.de/gesellschaft/zeitgeschehen/2020-07/anders/original__350x467__mobile",
                  caption:
                    "Dr. Anders Ravik Jupskås, Deputy Head of the Center for Research on Extremism (C-REX), University of Oslo © private",
                  text:
              ...
              },
              {
                ...
                image_and_text: {
                  url:
                    "https://img.zeit.de/gesellschaft/zeitgeschehen/2020-07/daniel-koehler/original__350x515__mobile",
                  caption:
                    "Dr. Daniel Köhler, Head of the German Institute on Radicalization and De-Radicalization Studies (GIRDS)",
                  text:
            ...
            [
              ...
              },
              {
                ...
                video: {
                  ...
                  caption:
                    "Für viele Menschen mit Migrationshintergrund waren Shisha-Bars bislang Rückzugsräume. Wie fühlen sie sich nach dem Attentat von Hanau? Unsere Reporter haben nachgefragt. © Foto: Sven Wolters / ZEIT Online",
                },
              },
              {
                type: "newsText",
